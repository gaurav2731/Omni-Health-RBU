...
// Overridable for tests / deployments; no import.meta so jest can transform this file.
const API_BASE = (typeof window !== 'undefined' && window.__API_BASE__) || 'http://localhost:3001';
